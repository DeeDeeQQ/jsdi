...
function Timer(){
    ...
    this.startRun = function(){
        ...
        this.interval = setInterval(function(){Timer.timeCount()},10)
    }
    ...
    document.getElementById('start_control').onclick = function(e){Timer.startRun()};
    document.getElementById('stop_control').onclick = function(e){Timer.stopRun()};
    document.getElementById('reset_control').onclick = function(e){Timer.resetRun()};
    document.getElementById('lap_control').onclick = function(e){Timer.newLap()};
